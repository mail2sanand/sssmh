...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG", "COPYING", "lib/mongrel/camping.rb", "lib/mongrel/cgi.rb", "lib/mongrel/command.rb", "lib/mongrel/configurator.rb", "lib/mongrel/const.rb", "lib/mongrel/debug.rb", "lib/mongrel/gems.rb", "lib/mongrel/handlers.rb", "lib/mongrel/header_out.rb", "lib/mongrel/http_request.rb", "lib/mongrel/http_response.rb", "lib/mongrel/init.rb", "lib/mongrel/rails.rb", "lib/mongrel/stats.rb", "lib/mongrel/tcphack.rb", "lib/mongrel/uri_classifier.rb", "lib/mongrel.rb", "lib/mongrel/mime_types.yml", "LICENSE", "README.markdown"]
  s.has_rdoc = true
  s.homepage = %q{http://mongrel.rubyforge.org}
  s.rdoc_options = ["--line-numbers", "--inline-source", "--title", "Mongrel", "--main", "README.markdown"]
...
#   p.rdoc_pattern = ['README.markdown', 'LICENSE', 'CHANGELOG', 'COPYING', 'lib/**/*.rb', 'doc/**/*.rdoc']
